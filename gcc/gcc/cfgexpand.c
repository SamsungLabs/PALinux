...
create_stack_guard (void)
{
  ...
  /* don't explictly reserve the canary space */
  if (aarch64_ra_sign_scope != AARCH64_FUNCTION_SSP ||
      aarch64_ra_sign_scope != AARCH64_FUNCTION_ALT)
