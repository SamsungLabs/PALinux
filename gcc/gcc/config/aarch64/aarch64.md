...
(define_insn "*do_return"
  ...
  ""
  {
    if (aarch64_return_address_signing_enabled ()
      ...
      if (aarch64_return_address_signing_for_alt()) {
        return "eor x30, x30, #0x000ff000; eor x30, x30, #0x00030000; eor x30, x30, #0x01ffff00; sub x30, sp, x30; eor x30, x30, #0x01ffff00; eor x30, x30, #0x00030000; eor x30, x30, #0x000ff000; ret";
      } else if (aarch64_return_address_signing_for_ssp()) {
        return "retab";
      } else {
        return "retaa";
      }
...
(define_insn "alternative_pauth"
  [(set (reg:DI R30_REGNUM)
	(unspec:DI [(reg:DI R30_REGNUM) (reg:DI SP_REGNUM)] UNSPEC_ALT_PAUTH))]
  ""
  "eor x30, x30, #0x000ff000; eor x30, x30, #0x00030000; eor x30, x30, #0x01ffff00; sub x30, sp, x30; eor x30, x30, #0x01ffff00; eor x30, x30, #0x00030000; eor x30, x30, #0x000ff000; // alternative pauth"
)
